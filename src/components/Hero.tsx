    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary/10 to-background dark:from-primary/5 dark:to-background">
      <div className="max-w-3xl mx-auto text-center px-4">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <a href="https://github.com/antenmanuuel" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
          ...
          <a href="https://www.linkedin.com/in/anten-manuuel/" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
        ...
        <a 
          href="https://drive.google.com/file/d/1dOl6uhSwqJjZxyclr0odS0ImwPN-n_-_/view?usp=sharing"
          target="_blank"
